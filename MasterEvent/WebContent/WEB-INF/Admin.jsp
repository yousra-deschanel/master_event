...
<html lang="en">
  <head>
    ...
    <title>Masster Event | Admin DashBoard</title>
  </head>
  <body id="body">
    <div class="container">
      <nav class="navbar">
          ...
          <div class="main__cards">
            <div class="card">
              ...
              <div class="card_inner">
                <p class="text-primary-p">Number of Clients</p>
            ...
            <div class="card">
              ...
              <div class="card_inner">
                <p class="text-primary-p">Upcomings</p>
                <span class="font-bold text-title">25/05/2021</span>
              </div>
            </div>
            ...
            <div class="card">
              ...
              ></i>
              <div class="card_inner">
                <p class="text-primary-p">Recordings</p>
            ...
            <div class="card">
              ...
              ></i>
              <div class="card_inner">
                <p class="text-primary-p">Reviews</p>
